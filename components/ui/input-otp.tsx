...
const InputOTPMessenger = React.forwardRef<React.ElementRef<"div">, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("absolute -bottom-0.5 left-0 text-[0.6rem] text-destructive", className)} {...props} />
  ),
)
InputOTPMessenger.displayName = "InputOTPMessenger"
...
export { InputOTP, InputOTPGroup, InputOTPSlot, InputOTPMessenger, InputOTPSeparator }
