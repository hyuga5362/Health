...
import {
  ...
  type ToastActionElement as RadixToastActionElement,
...
const ToastAction = React.forwardRef<React.ElementRef<typeof ToastPrimitives.Action>, RadixToastActionElement>(
  ({ className, ...props }, ref) => (
